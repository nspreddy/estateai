...
// New creates a new ZillowAPI client.
func New(zwsId string) ZillowAPI {
	return NewExt(zwsId, baseUrl)
}

// NewExt creates a new ZillowAPI client.
// It's like New but accepts more options.
func NewExt(zwsId, baseUrl string) ZillowAPI {
...
const (
	...
	phoParam             = "pho"
	petsParam            = "pets"
	parkingParam         = "praking"
	laundryParam         = "laundry"
	incomeResrictedParam = "income-restricted"
	frbldgParam          = "fr-bldg"
	pndParam             = "pnd"
	redParam             = "red"
	zsoParam             = "zso"
	...
	pParam               = "p"
	searchParam          = "search"
	isMapSearchParam     = "isMapSearch"
	listrightParam       = "listright"
)
